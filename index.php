...
if (file_exists('db/suzanayten.txt')) {
        ...
        <div class="card <?= cooki('color') ? cooki('color') : 'bg-dark'; ?>" style="width: 18rem;">
            ...
            <div class="card-body">
                ...
                <form action="islem.php?islem=hakkimda" method="POST">
                    <textarea class="form-control <?= cooki('color') ? cooki('color') : 'bg-dark'; ?> text-primary" name="hakkimda" id="" cols="30" rows="10"><?= htmlspecialchars_decode($hakkimda) ?></textarea>
